...
export const CalendarIcon = () => (
  <svg width="24" height="24" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect width="48" height="48" fill="white" fillOpacity="0.01" />
    <rect x="4" y="8" width="40" height="36" fill="none" stroke="#4a90e2" strokeWidth="4" strokeLinejoin="round" />
    <path fillRule="evenodd" clipRule="evenodd" d="M28 20V34H36V20H28Z" stroke="#4a90e2" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M17 4V12" stroke="#4a90e2" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M31 4V12" stroke="#4a90e2" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M12 20H20V34H12" stroke="#4a90e2" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M20 27H14" stroke="#4a90e2" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
)
